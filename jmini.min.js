...
/* JSON.load */ JSON.load=async function(t,n){return fetch(t,n).then((t=>{if(!t.ok)throw new Error("HTTP Status "+t.status+" – "+t.statusText);return t.json()}))};
...
/* $p.url (URL) */ $p.url={_init:function(i){$p._callInit(this,!0),i._callInit(this),this.init&&this.init(this)}};
